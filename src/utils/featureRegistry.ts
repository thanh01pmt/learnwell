...
export const FEATURE_REGISTRY: FeatureDefinition[] = [
	{
		...
		routes: [
			{
				path: "/admin",
				name: "features:routes.admin.dashboard",
			...
			{
				path: "/admin/users",
				name: "features:routes.admin.users",
				icon: Users,
				defaultRoles: ["admin"],
				parentPath: "/admin",
			},
			{
				path: "/admin/teachers",
				name: "features:routes.admin.teachers",
				icon: UserCog,
				defaultRoles: ["admin"],
				parentPath: "/admin",
			},
			{
				path: "/admin/reports",
				name: "features:routes.admin.reports",
				icon: FileText,
				defaultRoles: ["admin"],
				parentPath: "/admin",
			},
	...
	},
	{
		...
		routes: [
			{
				path: "/contests",
				name: "features:routes.contests.list",
				icon: Trophy,
			...
			},
			{
				...
				name: "features:routes.contests.detail",
				icon: FileText,
				defaultRoles: ["student", "teacher", "admin"],
				parentPath: "/contests",
			},
			{
				path: "/contests/arena",
				name: "features:routes.contests.arena",
				icon: Target,
				defaultRoles: ["student", "admin"],
				parentPath: "/contests",
			},
			{
				path: "/contests/leaderboard",
				name: "features:routes.contests.leaderboard",
				icon: BarChart3,
				defaultRoles: ["student", "teacher", "admin"],
				parentPath: "/contests",
			},
		...
		routes: [
			{
				...
				name: "features:routes.student.roadmap",
				icon: Route,
				defaultRoles: ["student", "parent", "admin"],
				isParent: true,
			},
			{
				path: "/student/skill-gap",
				name: "features:routes.student.skillGap",
				icon: TrendingUp,
				defaultRoles: ["student", "admin"],
				parentPath: "/student/roadmap",
			},
			{
				path: "/student/adaptive-practice",
				name: "features:routes.student.adaptivePractice",
				icon: Brain,
				defaultRoles: ["student", "admin"],
				parentPath: "/student/roadmap",
			},
			{
				...
				name: "features:routes.common.recommendations",
				icon: Star,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/resources",
				name: "features:routes.common.resources",
				icon: Library,
				defaultRoles: ["student", "teacher", "admin"],
				isParent: true,
			},
			{
				path: "/learning-paths",
				name: "features:routes.common.learningPaths",
				icon: Map,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
	...
	},
	{
		...
		routes: [
			{
				path: "/",
				name: "features:routes.teacher.dashboard",
				icon: LayoutDashboard,
				defaultRoles: ["teacher"],
			},
			{
				path: "/classes",
				name: "features:routes.teacher.classes",
				icon: School,
				defaultRoles: ["teacher"],
				isParent: true,
			},
			{
				path: "/classes/detail",
				name: "features:routes.teacher.classDetail",
				icon: FileText,
				defaultRoles: ["teacher"],
				parentPath: "/classes",
			},
			{
				path: "/students",
				name: "features:routes.teacher.students",
				icon: Users,
				defaultRoles: ["teacher"],
				parentPath: "/classes",
			},
			{
				path: "/grading",
				name: "features:routes.teacher.grading",
				icon: PenTool,
				defaultRoles: ["teacher"],
				parentPath: "/classes",
			},
			{
				path: "/gradebook",
				name: "features:routes.teacher.gradebook",
				icon: GraduationCap,
				defaultRoles: ["teacher"],
				parentPath: "/classes",
			},
	...
	},
	{
		...
		routes: [
			{
				path: "/student",
				name: "features:routes.student.dashboard",
				icon: LayoutDashboard,
				defaultRoles: ["student"],
			},
			{
				path: "/student/assignments",
				name: "features:routes.student.assignments",
				icon: FileText,
				defaultRoles: ["student"],
				isParent: true,
			},
			{
				...
				name: "features:routes.student.materials",
				icon: BookOpen,
				defaultRoles: ["student"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/playground",
				name: "features:routes.common.playground",
				icon: Terminal,
				defaultRoles: ["student", "teacher", "admin"],
			},
			{
				path: "/hub",
				name: "features:routes.common.projectHub",
				icon: FolderOpen,
				defaultRoles: ["student", "teacher", "admin"],
			},
			{
				path: "/problems",
				name: "features:routes.common.problems",
				icon: Code2,
				defaultRoles: ["student", "teacher", "admin"],
				isParent: true,
			},
			{
				path: "/solutions",
				name: "features:routes.common.solutions",
				icon: Lightbulb,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/shop",
				name: "features:routes.common.shop",
				icon: ShoppingCart,
				defaultRoles: ["student", "admin"],
			},
			{
				path: "/teams",
				name: "features:routes.common.teams",
				icon: Users2,
				defaultRoles: ["student", "admin"],
			},
			{
				path: "/achievements",
				name: "features:routes.common.achievements",
				icon: Award,
				defaultRoles: ["student", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/forum",
				name: "features:routes.common.forum",
				icon: MessageSquare,
				defaultRoles: ["student", "teacher", "admin"],
				isParent: true,
			},
			{
				path: "/social-feed",
				name: "features:routes.common.socialFeed",
				icon: Share2,
				defaultRoles: ["student", "admin"],
			},
			{
				path: "/study-groups",
				name: "features:routes.common.studyGroups",
				icon: Users,
				defaultRoles: ["student", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/parent",
				name: "features:routes.parent.dashboard",
				icon: LayoutDashboard,
				defaultRoles: ["parent"],
			},
			{
				path: "/parent/progress",
				name: "features:routes.parent.progress",
				icon: TrendingUp,
				defaultRoles: ["parent"],
				isParent: true,
			},
			{
				path: "/parent/report",
				name: "features:routes.parent.report",
				icon: FileBarChart,
				defaultRoles: ["parent"],
				parentPath: "/parent/progress",
			},
			{
				path: "/parent/attendance",
				name: "features:routes.parent.attendance",
				icon: Calendar,
				defaultRoles: ["parent"],
				parentPath: "/parent/progress",
			},
			{
				path: "/parent/contact",
				name: "features:routes.parent.contact",
				icon: MessageCircle,
				defaultRoles: ["parent"],
			},
			{
				path: "/parent/schedule",
				name: "features:routes.parent.schedule",
				icon: Calendar,
				defaultRoles: ["parent"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.common.portfolioBuilder",
				icon: Briefcase,
				defaultRoles: ["student", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/student/autonomy",
				name: "features:routes.student.autonomy",
				icon: Timer,
				defaultRoles: ["student", "admin"],
			},
			{
				path: "/student/planner",
				name: "features:routes.student.planner",
				icon: Calendar,
				defaultRoles: ["student", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.student.artifacts",
				icon: FolderOpen,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.teacher.interventions",
				icon: ShieldAlert,
	...
	},
	{
		...
		routes: [
			{
				path: "/teacher/formative",
				name: "features:routes.teacher.formative",
				icon: Gauge,
				defaultRoles: ["teacher", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.parent.curriculum",
				icon: BookOpen,
				defaultRoles: ["parent", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				...
				name: "features:routes.parent.communications",
				icon: MessageCircle,
				defaultRoles: ["parent", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/student/materials/rich",
				name: "features:routes.student.richMaterials",
				icon: PlayCircle,
				defaultRoles: ["student", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.admin.analytics",
				icon: BarChart3,
				defaultRoles: ["admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.admin.resources",
				icon: Database,
				defaultRoles: ["admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/student/materials/audio",
				name: "features:routes.student.audioLessons",
				icon: Mic2,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/student/materials/mindmaps",
				name: "features:routes.common.mindMaps",
				icon: Network,
				defaultRoles: ["student", "teacher", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.common.credentials",
				icon: Milestone,
				defaultRoles: ["student", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/parent/home-activities",
				name: "features:routes.parent.homeActivities",
				icon: Home,
				defaultRoles: ["parent", "admin"],
			},
		],
		...
		routes: [
			{
				...
				name: "features:routes.teacher.exitTickets",
				icon: Ticket,
				defaultRoles: ["teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/teacher/path-templates",
				name: "features:routes.teacher.pathTemplates",
				icon: ScrollText,
				defaultRoles: ["teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/teacher/iep",
				name: "features:routes.teacher.iep",
				icon: Contact2,
				defaultRoles: ["teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/student/study-buddies",
				name: "features:routes.common.studyBuddies",
				icon: Group,
				defaultRoles: ["student", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/teacher/skill-groups",
				name: "features:routes.teacher.skillGroups",
				icon: Users,
				defaultRoles: ["teacher", "admin"],
			},
		],
	},
	{
		...
		routes: [
			{
				path: "/admin/cohort-tracking",
				name: "features:routes.admin.cohortTracking",
				icon: BarChart3,
				defaultRoles: ["admin"],
			},
		],
	},
	{
		...
		name: "features:features.authoring.name",
		description: "features:features.authoring.description",
		category: "authoring",
		priority: "high",
		routes: [
			{
				path: "/authoring/questions",
				name: "features:routes.authoring.questions",
				icon: Database,
				defaultRoles: ["instructional_designer", "admin"],
			},
			{
				path: "/authoring/curriculum",
				name: "features:routes.authoring.curriculum",
				icon: Map,
				defaultRoles: ["instructional_designer", "admin"],
			},
			{
				path: "/authoring/exams",
				name: "features:routes.authoring.exams",
				icon: FileText,
				defaultRoles: ["instructional_designer", "admin"],
			},
			{
				path: "/authoring/tutorial-builder",
				name: "features:routes.authoring.tutorialBuilder",
				icon: PenTool,
				defaultRoles: ["instructional_designer", "admin"],
			},
			{
				path: "/authoring/grading-config",
				name: "features:routes.authoring.gradingConfig",
				icon: Settings,
				defaultRoles: ["assessor", "admin"],
			},
		],
	},
];
