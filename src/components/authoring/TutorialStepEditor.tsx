        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Loại nội dung</Label>
                        <div className="grid grid-cols-3 gap-3">
                            {[
                                { id: 'video', label: 'Video', icon: Video },
                                { id: 'info', label: 'Lý thuyết', icon: Type },
                                { id: 'task', label: 'Thực hành', icon: Layout },
                            ].map((item) => (
                ...
                <div className="space-y-6">
                    <div className="space-y-4">
                        <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">URL Video / Media</Label>
                    ...
                    <div className="p-4 bg-muted/30 rounded-xl border border-dashed border-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xs font-bold">Thumbnail tự động</span>
                                <span className="text-[10px] text-muted-foreground font-medium">Lấy từ link API YouTube...</span>
                            </div>
                        </div>
                        <Switch />
                    </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <Label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Nội dung hướng dẫn chi tiết</Label>
                ...
                <div className="min-h-[200px] border-2 rounded-xl p-4 bg-background shadow-inner relative group">
                    <Textarea
                        placeholder="Nhập nội dung Markdown hoặc văn bản hướng dẫn tại đây..."
                    ...
                    <div className="absolute bottom-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="p-1 px-2 rounded bg-muted text-[10px] font-black uppercase cursor-help">Markdown Supported</div>
                    </div>
                </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                        <h4 className="font-bold text-sm flex items-center gap-2">
                            ...
                            Danh sách kiểm tra nhiệm vụ (Tasks)
                        </h4>
                        <p className="text-[10px] text-muted-foreground font-medium">Học sinh cần tick hết các mục này để qua bước kế tiếp.</p>
                    </div>
            ...
            <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-200 flex items-start gap-3">
                ...
                <p className="text-[11px] text-blue-700 leading-relaxed font-medium">
                    <strong>Mẹo:</strong> Sử dụng <code>[instruction]...[/instruction]</code> để tạo khối văn bản nổi bật trong ứng dụng xem trình chiếu của học sinh.
                </p>
            </div>
        </div>
    );
